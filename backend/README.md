...
## Project Structure
    ...
    ├── testapiautostoryboa_84469  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_84469`
...
2. Clone this repo and `cd testapiautostoryboa_84469`
